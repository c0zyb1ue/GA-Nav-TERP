...
global vel_cmd
vel_cmd =Twist()
# self.sub_cmd_vel = rospy.Subscriber('/jackal/cmd_vel_DWA', Twist, self.getVel)
...
vel_sub = rospy.Subscriber('/jackal/cmd_vel_DWA', Twist, getVel)
...
while not arrive:
    ...
    #print(f"action_ddpg : {action_ddpg}, cbam_out: {cbam_out}, cbam_in: {cbam_in}")
    ...
    if t_stamp ==0 or grid_arrived:
        ...
        print('================================ WAY POINT PLANNER ================================')
        print(grid_waypoint_coords_wrt_odom)
